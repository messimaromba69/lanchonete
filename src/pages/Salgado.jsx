...
export default function Salgados() {
  ...
  const produtos = [
    { nome: "Assado do dia", preco: 7.5, img: "" },
    { nome: "Misto quente", preco: 5.0, img: "" },
    { nome: "Bauru", preco: 5.5, img: "" },
    { nome: "Sanduíche natural", preco: 7.5, img: "" },
    { nome: "Pão de queijo", preco: 3.0, img: "" },
  ];
