...
export default function SescPayment() {
  ...
  const handlePay = (method) => {
    // Simples simulação: limpa carrinho e mostra confirmação
  ...
  return (
    <div className="min-h-screen bg-white p-4">
      ...
      <h2 className="text-center text-blue-700 text-xl font-semibold mt-4">Pagamento</h2>
      ...
      <div className="max-w-md mx-auto mt-6 space-y-4">
        ...
        <button onClick={() => navigate("/carrinho")} className="w-full bg-blue-700 text-white py-3 rounded font-semibold">Voltar ao carrinho</button>
      </div>
    </div>
  );
}
